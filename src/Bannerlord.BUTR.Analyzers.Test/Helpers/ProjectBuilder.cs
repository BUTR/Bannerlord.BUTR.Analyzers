...
namespace TestHelper
{
    public sealed partial class ProjectBuilder
    {
        ...
        private static Task<string[]> GetNuGetReferences(string packageName, string version, string path)
        {
            ...
            {
                var tempFolder = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Bannerlord.HarmonyAnalyzer.Test", "ref", packageName + '@' + version);
